...
export const alerts: ComponentType = {
  ...
  <div class="flex">
    ...
    },
    {
      ...
      code: `<div class="bg-gradient-to-r from-lime-500 to-lime-600 dark:from-lime-300 dark:to-lime-400">
  <div class="container mx-auto px-4 py-3">
    <div class="flex flex-col sm:flex-row items-center justify-between">
      <div class="flex items-center">
        <svg class="h-5 w-5 text-white dark:text-gray-900" viewBox="0 0 20 20" fill="currentColor">
        ...
        <p class="ml-2 text-sm font-medium text-white text-center sm:text-left dark:text-gray-900">
          Limited time offer! Get 50% off on all annual plans.
        </p>
      </div>
      <div class="mt-2 sm:mt-0">
        <button class="bg-white text-lime-600 hover:bg-lime-50 px-4 py-1.5 text-sm font-medium rounded-md transition-colors duration-300 dark:bg-gray-900 dark:text-lime-300 dark:hover:bg-gray-800">
          Claim offer
        </button>
      </div>
    </div>
