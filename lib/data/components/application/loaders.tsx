...
export const loaders: ComponentType = {
  ...
  <svg class="size-10 animate animate-spin" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-labelledby="title-04a desc-04a" aria-live="polite" aria-busy="true">
    ...
    <path d="M12 22C14.6522 22 17.1957 20.9464 19.0711 19.0711C20.9464 17.1957 22 14.6522 22 12C22 9.34784 20.9464 6.8043 19.0711 4.92893C17.1957 3.05357 14.6522 2 12 2" class="stroke-lime-600 dark:stroke-lime-300" stroke-width="4" />
  </svg>
</div>`,
      contributor: 'rayasabari',
    },
  ...
  <div class="h-3 w-3 bg-lime-600 dark:bg-lime-300 rounded-full animate-bounce [animation-delay:-0.3s]"></div>
  <div class="h-3 w-3 bg-lime-600 dark:bg-lime-300 rounded-full animate-bounce [animation-delay:-0.15s]"></div>
  <div class="h-3 w-3 bg-lime-600 dark:bg-lime-300 rounded-full animate-bounce"></div>
</div>`,
      contributor: 'rayasabari',
    },
    {
  ...
  <span class="relative flex h-8 w-8">
    <span class="animate-ping absolute inline-flex h-full w-full rounded-full bg-lime-400 dark:bg-lime-300 opacity-75"></span>
    <span class="relative inline-flex rounded-full h-8 w-8 bg-lime-500 dark:bg-lime-300"></span>
  </span>
</div>`,
      contributor: 'rayasabari',
    },
  ...
  <div class="w-1.5 h-4 bg-lime-500 dark:bg-lime-300 animate-[pulse_1s_ease-in-out_infinite] [animation-delay:-0.4s]"></div>
  <div class="w-1.5 h-6 bg-lime-500 dark:bg-lime-300 animate-[pulse_1s_ease-in-out_infinite] [animation-delay:-0.2s]"></div>
  <div class="w-1.5 h-8 bg-lime-500 dark:bg-lime-300 animate-[pulse_1s_ease-in-out_infinite]"></div>
  <div class="w-1.5 h-6 bg-lime-500 dark:bg-lime-300 animate-[pulse_1s_ease-in-out_infinite] [animation-delay:-0.2s]"></div>
  <div class="w-1.5 h-4 bg-lime-500 dark:bg-lime-300 animate-[pulse_1s_ease-in-out_infinite] [animation-delay:-0.4s]"></div>
</div>`,
      contributor: 'rayasabari',
